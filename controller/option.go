...
type ChannelConsecutiveErrorFeishuTestRequest struct {
...
func UpdateOption(c *gin.Context) {
	...
	case "group_delay_setting.rules":
		_, err = operation_setting.ParseGroupDelayRules(option.Value.(string))
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
	...
	case "large_prompt_rpm_setting.rules":
		_, err = operation_setting.ParseLargePromptRPMRules(option.Value.(string))
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
...
func SendChannelConsecutiveErrorFeishuTestCard(c *gin.Context) {
	var req ChannelConsecutiveErrorFeishuTestRequest
	...
	if err := service.SendChannelConsecutiveErrorTestCard(req.AppID, req.AppSecret, req.ChatID); err != nil {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": err.Error(),
		})
