...
func AddRedemption(c *gin.Context) {
	...
	for i := 0; i < redemption.Count; i++ {
		...
		cleanRedemption := model.Redemption{
			...
			LotteryBalanceType:  redemption.LotteryBalanceType,
