...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/status/monitor", controller.GetRequestStatusMonitor)
		...
		apiRouter.GET("/verification", middleware.PublicRequestSignatureRequired(), middleware.EmailVerificationRateLimit(), middleware.TurnstileCheck(), controller.SendEmailVerification)
		...
		apiRouter.POST("/alipay/f2f/notify", controller.AlipayF2FNotify)
		...
		{
			userRoute.POST("/register", middleware.PublicRequestSignatureRequired(), middleware.CriticalRateLimit(), controller.Register)
			userRoute.POST("/login", middleware.PublicRequestSignatureRequired(), middleware.CriticalRateLimit(), controller.Login)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/alipay_f2f/pay", middleware.CriticalRateLimit(), middleware.AlipayF2FCreateOrderRateLimit(), controller.RequestAlipayF2FPay)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/aff_withdrawals/:id", controller.GetInviteWithdrawal)
				...
				adminRoute.POST("/topup/refund/manual", controller.AdminManualRefundTopUp)
				adminRoute.GET("/search", controller.SearchUsers)
				adminRoute.GET("/:id/invite-overview", controller.GetAdminInviteOverview)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/channel_error_feishu_test", controller.SendChannelConsecutiveErrorFeishuTestCard)
		...
		logRoute.GET("/:id/detail", middleware.AdminAuth(), controller.GetLogDetail)
