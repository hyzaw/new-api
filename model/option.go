...
func InitOptionMap() {
	...
	common.OptionMap["AlipayAppAuthToken"] = setting.AlipayAppAuthToken
	...
	common.OptionMap["TopUpAffRatio"] = strconv.FormatFloat(common.TopUpAffRatio, 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AlipayAppAuthToken":
		setting.AlipayAppAuthToken = value
	case "AlipaySellerID":
	...
	case "TopUpAffRatio":
		common.TopUpAffRatio, _ = strconv.ParseFloat(value, 64)
