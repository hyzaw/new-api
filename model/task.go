...
type TaskPrivateData struct {
	...
	WalletBaseQuota         int                 `json:"wallet_base_quota,omitempty"`
	WalletBaseGiftQuota     int                 `json:"wallet_base_gift_quota,omitempty"`
	WalletConsumedQuota     int                 `json:"wallet_consumed_quota,omitempty"`
	WalletConsumedGiftQuota int                 `json:"wallet_consumed_gift_quota,omitempty"`
	WalletGiftEligible      bool                `json:"wallet_gift_eligible,omitempty"`
